<template>
  <HeadingBanner heading="Kontakty"/>
  ...
  <div class="content">
    ...
    <div class="whistleblowing">
      <div class="heading">Whistleblowing</div>
      ...
      <div>
        ...
        <span class="mailAdress">oznamovaci.linka(zavinac)ekos-zitenice.cz</span>
      </div>
    </div>
  </div>
</template>
...
.location .locationContent .locationCenter{
  display: flex;
  flex-direction: column;
  height: 100%;
  width: 100%;
...
.whistleblowing .mailTitle{
  font-weight: bold;
  padding-right: 10px;
}

.whistleblowing .mailAdress{
  color: #0A9E09;
  font-weight: bold;
}
